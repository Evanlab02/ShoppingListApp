"""Contains the AtlernativeBaseTestCase class for end-to-end tests."""
...
# Mock data
MOCK_USERNAME = "basetestuser2"
MOCK_PASSWORD = "testuser2"


class AlternativeBaseTestCase(TestCase):
