...
SECRET_KEY = getenv("TESTING_DJANGO_KEY")

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = [getenv("TESTING_DJANGO_HOST", "localhost")]
...
DATABASES = {
    "default": {
        ...
        "NAME": getenv("TESTING_DATABASE_NAME"),
        "USER": getenv("TESTING_DATABASE_USER"),
