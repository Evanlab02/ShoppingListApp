...
class TestStoreService(TestCase):
    ...
    async def test_search_stores_by_name(self) -> None:
        ...
        stores = await self.service.search_stores(name="Test Store", sort="name", sort_dir="asc")
    ...
    async def test_search_stores_by_user(self) -> None:
        ...
        stores = await self.service.search_stores(user=user)
    ...
    async def test_search_stores_by_ids(self) -> None:
        ...
        stores = await self.service.search_stores(search=search)
    ...
    async def test_search_stores_by_created_on(self) -> None:
        ...
        stores = await self.service.search_stores(search=self.search)
